...
const content = FINANCE_PAGES["credit-cards"];

const DESCRIPTION =
  "Annual fees, rewards rates and welcome bonuses from Canadian credit card issuers, compared side by side.";
...
export const metadata: Metadata = {
  title: "Compare Credit Cards | SaveIQ Finance",
